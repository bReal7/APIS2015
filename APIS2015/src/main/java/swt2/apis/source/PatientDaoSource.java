...
//    }
    ...
    private Patient patDtoToEntity(PatientDto nPat) {
        ...
        pat.setVersicherungsverhaeltnis(nPat.getInsuranceContract().toString());
    ...
    private PatientDto entityToPatDto(Patient pat) {
        ...
        patDto.setInsuranceContract(pat.getVersicherungsverhaeltnis().toString());
